...
==Issues
  - cant revert unless commited
    revert should first commit a craft regardless of save mode

  - cant update commit message while craft is in a untracked state
    force save?
...
==Planned/Todo
  - recovery of deleted craft interface
